 ...
 * borrow with GS013. Exposed for any consumer that wants to render
 * progress against the cap (the SavingsCard has its own inline copy
 * because importing this lib into a client component pulls
 * node:child_process into the bundle). */
